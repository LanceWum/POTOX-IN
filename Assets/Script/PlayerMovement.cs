...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        if(LevelManager.instance.botox==0)return;
        if(isAttack)return;
    ...
    void AttackPerformed(InputAction.CallbackContext obj)
    {
        ...
        if(obj.interaction is HoldInteraction)
        {
            ...
            AttackType="Heavy";
            isAttack=true;
            if(LevelManager.instance.botox<30)LevelManager.instance.botox=0;
            else LevelManager.instance.botox-=30;
        }
        else if(obj.interaction is TapInteraction)
        {
            ...
            AttackType="Light";
            isAttack=true;
            if(LevelManager.instance.botox<10)LevelManager.instance.botox=0;
            else LevelManager.instance.botox-=10;
        }
    }
